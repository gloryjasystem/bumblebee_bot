...
from handlers.welcome_seq import router as welcome_seq_router
...
from middlewares.custom_emoji import CustomEmojiMiddleware  # премиум-иконки в текстах (за флагом)
...
def build_dispatcher() -> Dispatcher:
    ...
    dp.include_router(welcome_seq_router)
...
async def main():
    ...
    # Премиум-иконки в текстах: перехватчик на сессии ТОЛЬКО главного бота.
    # При custom_emoji_enabled=False проходит насквозь (прод не меняется).

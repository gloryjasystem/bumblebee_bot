...
HELP_TEXT = (
    ...
    "прямо здесь.\n\n"
    "Инструменты ниже работают <b>после подключения бота</b>: откройте «🤖 Мой "
    "список ботов» → выберите бота → его меню. Один бот ведёт сразу несколько "
    "каналов и групп.\n\n"
    "<b>Что внутри:</b>\n\n"
    ...
    "администраторов.\n\n"
    "📊 <b>Статистика</b> — живые цифры по каждому боту и каналу.\n\n"
